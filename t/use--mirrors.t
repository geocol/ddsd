...
Test {
  ...
  return $current->prepare ({
    ...
    return $current->run ('use', additional => ["foo", "package:activity.html"], app => 1);
  })->then (sub {
    ...
    return $current->run ('unuse', additional => ["foo", "package:activity.html"], app => 1);
  })->then (sub {
